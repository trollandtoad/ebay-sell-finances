...
class TransactionApi
{
     ...
     * @return \eBay\Sell\Finances\Model\TransactionSummaryResponse
     */
     ...
     * @throws \eBay\Sell\Finances\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \eBay\Sell\Finances\Model\TransactionSummaryResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTransactionSummaryWithHttpInfo($filter = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eBay\Sell\Finances\Model\TransactionSummaryResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\eBay\Sell\Finances\Model\TransactionSummaryResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\eBay\Sell\Finances\Model\TransactionSummaryResponse';
            $responseBody = $response->getBody();
     ...
     * @throws \eBay\Sell\Finances\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \eBay\Sell\Finances\Model\Transactions
     */
     ...
     * @throws \eBay\Sell\Finances\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \eBay\Sell\Finances\Model\Transactions, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTransactionsWithHttpInfo($filter = null, $sort = null, $limit = null, $offset = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\eBay\Sell\Finances\Model\Transactions' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\eBay\Sell\Finances\Model\Transactions', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\eBay\Sell\Finances\Model\Transactions';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
