...
class Fee implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets fee_type
     *
     * @param string|null $fee_type The enumeration value returned here indicates the type of fee that was deducted from the seller's payout. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/sell/finances/types/api:FeeTypeEnum'>eBay API documentation</a>
     *
     * @return self
     */
