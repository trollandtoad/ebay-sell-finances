...
class Transaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'buyer' => '\eBay\Sell\Finances\Model\Buyer',
        'order_id' => 'string',
        'order_line_items' => '\eBay\Sell\Finances\Model\OrderLineItem[]',
        'payments_entity' => 'string',
        'payout_id' => 'string',
        'sales_record_reference' => 'string',
        'total_fee_basis_amount' => '\eBay\Sell\Finances\Model\Amount',
        'total_fee_amount' => '\eBay\Sell\Finances\Model\Amount',
     ...
     * Gets buyer
     *
     * @return \eBay\Sell\Finances\Model\Buyer|null
     */
     ...
     * Sets buyer
     *
     * @param \eBay\Sell\Finances\Model\Buyer|null $buyer buyer
     *
     * @return self
     */
     ...
     *
     * @return \eBay\Sell\Finances\Model\OrderLineItem[]|null
     */
     ...
     *
     * @param \eBay\Sell\Finances\Model\OrderLineItem[]|null $order_line_items This array shows the fees that are deducted from a seller payout for each line item in an order.
     *
     * @return self
     */
     ...
     *
     * @param \eBay\Sell\Finances\Model\Amount|null $total_fee_basis_amount total_fee_basis_amount
     *
     * @return self
     */
     ...
     *
     * @param \eBay\Sell\Finances\Model\Amount|null $total_fee_amount total_fee_amount
     *
     * @return self
     */
     ...
     *
     * @param string|null $transaction_date This timestamp indicates when the monetary transaction (order purchase, buyer refund, seller credit) occurred. The following format is used: YYYY-MM-DDTHH:MM:SS.SSSZ. For example, 2015-08-04T19:09:02.768Z.
     *
     * @return self
     */
