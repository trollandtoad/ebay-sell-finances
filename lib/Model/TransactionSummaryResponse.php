...
class TransactionSummaryResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'credit_amount' => '\eBay\Sell\Finances\Model\Amount',
        'credit_booking_entry' => 'string',
        'credit_count' => 'int',
        'dispute_amount' => '\eBay\Sell\Finances\Model\Amount',
        'dispute_booking_entry' => 'string',
        'dispute_count' => 'int',
        'on_hold_amount' => '\eBay\Sell\Finances\Model\Amount',
        'on_hold_booking_entry' => 'string',
        'on_hold_count' => 'int',
        'refund_amount' => '\eBay\Sell\Finances\Model\Amount',
        'refund_booking_entry' => 'string',
        'refund_count' => 'int',
        'shipping_label_amount' => '\eBay\Sell\Finances\Model\Amount',
     ...
     * Sets credit_amount
     *
     * @param \eBay\Sell\Finances\Model\Amount|null $credit_amount credit_amount
     *
     * @return self
     */
     ...
     * Sets dispute_amount
     *
     * @param \eBay\Sell\Finances\Model\Amount|null $dispute_amount dispute_amount
     *
     * @return self
     */
     ...
     * Sets on_hold_amount
     *
     * @param \eBay\Sell\Finances\Model\Amount|null $on_hold_amount on_hold_amount
     *
     * @return self
     */
     ...
     * Sets refund_amount
     *
     * @param \eBay\Sell\Finances\Model\Amount|null $refund_amount refund_amount
     *
     * @return self
     */
     ...
     * Sets refund_count
     *
     * @param int|null $refund_count This integer value indicates the total number of buyer refunds that match the input criteria. This field is generally returned, even if 0, but it will not be returned if a transactionType filter is used, and its value is set to any value other than REFUND.
     *
     * @return self
     */
     ...
     *
     * @param \eBay\Sell\Finances\Model\Amount|null $shipping_label_amount shipping_label_amount
     *
     * @return self
     */
     ...
     * Sets transfer_count
     *
     * @param int|null $transfer_count This integer value indicates the total number of buyer refund transfers that match the input criteria. This field is generally returned, even if 0, but it will not be returned if a transactionType filter is used, and its value is set to any value other than TRANSFER.
     *
     * @return self
     */
